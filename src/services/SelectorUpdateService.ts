...
export class SelectorUpdateService {
     ...
     */
    async updateFormCreationSelectors(selectors: FormCreationSelectorOverrides): Promise<void> {
        try {
            this.logger.info('Updating form creation selectors', 'SelectorUpdateService', { selectors });
            ...
            this.logger.info(UserMessages.SUCCESS.SELECTORS_UPDATED, 'SelectorUpdateService');
        } catch (error) {
    ...
    async executeFormCreationWithCurrentSelectors(): Promise<void> {
        try {
            this.logger.info('Starting form creation automation', 'SelectorUpdateService');
            ...
            this.logger.info('Automation sequence sent to content script', 'SelectorUpdateService');
        } catch (error) {
            this.logger.logError(error as Error, 'SelectorUpdateService');
            throw error;
        }
